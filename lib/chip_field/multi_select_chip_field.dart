...
class _MultiSelectChipFieldView<V> extends StatefulWidget with MultiSelectActions {
  ...
  _MultiSelectChipFieldView.withState(_MultiSelectChipFieldView<V> field, FormFieldState<List<V>> state)
      : items = field.items,
        title = field.title,
        ...
        Container(
          ...
          child: Column(
            children: [
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        focusedBorder: UnderlineInputBorder(
                                          borderSide: BorderSide(
                                            color: widget.selectedChipColor ?? Theme.of(context).primaryColor,
                                          ),
                                        ),
                                      ),
                                      onChanged: (val) {
                              ...
                              : Padding(
                                  ...
                                  child: widget.title != null
                                      ? Text(
                                          widget.title!.data!,
                                          style: TextStyle(
                                              color: widget.title!.style != null ? widget.title!.style!.color : null,
              ...
              widget.scroll
                  ? Container(
                      padding: widget.itemBuilder == null ? EdgeInsets.symmetric(horizontal: 5) : null,
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (ctx, index) {
                                  return widget.itemBuilder != null
                                      ? widget.itemBuilder!(_items[index] as MultiSelectItem<V>, widget.state!)
                  ...
                  : Container(
                      ...
                      child: Wrap(
                        children: widget.itemBuilder != null
                            ? _items
                                .map((item) => widget.itemBuilder!(item as MultiSelectItem<V>, widget.state!))
                                .toList()
                            : _items.map((item) => _buildItem(item as MultiSelectItem<V?>)).toList(),
                      ),
                    ),
            ],
          ),
            ...
            ? widget.icon != null
                ? Icon(
                    ...
                    color: widget.colorator != null && widget.colorator!(item.value) != null
                        ...
                        : widget.icon!.color ?? widget.selectedChipColor ?? Theme.of(context).primaryColor,
                  )
                : null
            : null,
        label: Container(
                ...
                ? TextStyle(
                    color: widget.colorator != null && widget.colorator!(item.value) != null
                        ...
                        : widget.selectedTextStyle != null
                            ...
                            : null)
                : TextStyle(
                    color: widget.textStyle != null ? widget.textStyle!.color ?? widget.chipColor : widget.chipColor,
